...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cost.nonconformity'
        db.add_column(u'qt_cost', 'nonconformity',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['qt.Nonconformity']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Cost.nonconformity'
        db.delete_column(u'qt_cost', 'nonconformity_id')
    ...
    models = {
        ...
        u'qt.cost': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nonconformity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['qt.Nonconformity']"}),
        ...
        u'qt.nonconformity': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['qt.Status']"}),
